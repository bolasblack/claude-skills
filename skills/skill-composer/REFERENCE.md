...
Admitted-suite mechanics and methodology live in the branch-only
[Evaluation Reference](references/evaluation.md), reached through Skill Composer's
conditional evaluation route.
